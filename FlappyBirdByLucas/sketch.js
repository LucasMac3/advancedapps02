...
// this is the code for the construction of the bird, his beak, and his eye, in addition is the code for the way in which the bird flies, I.e. the speed of the bird and the gravity of which he effected 
function Bird() {
  this.y = height/2;
  this.x = 64;
